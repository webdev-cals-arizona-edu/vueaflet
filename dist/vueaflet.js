...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_leaflet__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_buses__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_store_mutation_types__ = __webpack_require__(1);
...
var LBasemap = {
  ...
  methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapMutations"])({
    ...
    removeLayer: __WEBPACK_IMPORTED_MODULE_3_store_mutation_types__["m" /* VUEAFLET_REMOVE_MAP_LAYER */]
  }))
};

/* harmony default export */ __webpack_exports__["a"] = (LBasemap);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_leaflet__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_leaflet___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_leaflet__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vuex__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_buses__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_store_mutation_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_utils__ = __webpack_require__(7);
...
var LFeatureGroup = {
  ...
  data: function data() {
    return {
      layerTypeLookup: __WEBPACK_IMPORTED_MODULE_5_utils__["a" /* layerTypeLookup */],
  ...
  created: function created() {
    ...
    this.innerFeatureGroup = existingFeatureGroup ? existingFeatureGroup : __WEBPACK_IMPORTED_MODULE_1_leaflet___default.a.featureGroup();

    this.layerName ? this.addNamedLayer({ id: this.mapId, name: this.layerName, layer: this.innerFeatureGroup }) : this.addLayer({ id: this.mapId, layer: this.innerFeatureGroup });
    ...
    events.forEach(function (event) {
      ...
      _this.innerFeatureGroup.on(event, function (ev) {
        __WEBPACK_IMPORTED_MODULE_3_buses__["a" /* MapBus */].$emit('feature-group-' + _this.mapId + '-' + event, _this.innerFeatureGroup);
      });
    });
  },
  mounted: function mounted() {
    this.$emit('ready', this.layerName);
    __WEBPACK_IMPORTED_MODULE_3_buses__["a" /* MapBus */].$emit('feature-group-' + this.mapId + '-ready', this.layerName);
  },
  destroyed: function destroyed() {
  ...
  computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapGetters"])(['getNamedLayer'])),

  methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapMutations"])({
    addLayer: __WEBPACK_IMPORTED_MODULE_4_store_mutation_types__["b" /* VUEAFLET_ADD_MAP_LAYER */],
    addNamedLayer: __WEBPACK_IMPORTED_MODULE_4_store_mutation_types__["c" /* VUEAFLET_ADD_NAMED_LAYER */],
    removeLayer: __WEBPACK_IMPORTED_MODULE_4_store_mutation_types__["m" /* VUEAFLET_REMOVE_MAP_LAYER */]
  }), Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapActions"])(['removeNamedLayer']))
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_values__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_buses__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_store_mutation_types__ = __webpack_require__(1);
...
__WEBPACK_IMPORTED_MODULE_2_leaflet___default.a.Icon.Default.mergeOptions({
  ...
  iconUrl: __webpack_require__(13),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vuex__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_store_mutation_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_forEach__ = __webpack_require__(46);
...
var events = ['load', 'click', 'dblclick'];
...
var LMap = {
  ...
  props: {
    ...
    // TODO: convert this into a config object
    zoom: {
      type: Number,
      default: 4
    },
    center: {
      type: [String, Array],
      default: function _default() {
        return [39.36827914916014, -97.86621093750001];
      }
    }
  },
  ...
  data: function data() {
    return {
      ...
      showControls: false,
      ready: false,
      startIndexAt: 699 // popup pane starts at 700
    };
  },


  computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapGetters"])(['getMap'])),

  methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapMutations"])({
    addEvent: __WEBPACK_IMPORTED_MODULE_3_store_mutation_types__["a" /* VUEAFLET_ADD_MAP_EVENT */],
    addLayer: __WEBPACK_IMPORTED_MODULE_3_store_mutation_types__["b" /* VUEAFLET_ADD_MAP_LAYER */]
  }), Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["mapActions"])(['createMap', 'destroyMap', 'add']), {
    createPanes: function createPanes() {
      var _this2 = this;

      var _map = this.getMap(this.mapId);

      __WEBPACK_IMPORTED_MODULE_4_lodash_forEach___default()(this.layers, function (layerName, index) {
        _map.createPane(layerName);
        _map.getPane(layerName).style.zIndex = _this2.startIndexAt - index;
      });
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mutation_types__ = __webpack_require__(1);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__LBasemap_LBasemap__ = __webpack_require__(26);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "LBasemap", function() { return __WEBPACK_IMPORTED_MODULE_0__LBasemap_LBasemap__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__LFeatureGroup_LFeatureGroup__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LGeoJsonCollection_LGeoJsonCollection__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LGeoJsonLayer_LGeoJsonLayer__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__LMap_LMap__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__LMarker_LMarker__ = __webpack_require__(48);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_LBasemap_vue__ = __webpack_require__(9);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_42a070af_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_LBasemap_vue__ = __webpack_require__(27);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_LBasemap_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_42a070af_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_LBasemap_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/LBasemap/LBasemap.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-42a070af", Component.options)
  } else {
    hotAPI.reload("data-v-42a070af", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-42a070af", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_LFeatureGroup_vue__ = __webpack_require__(10);
/* unused harmony namespace reexport */
            ...
            _vm._b(
              {
                key: layer.id,
                tag: "component",
                attrs: { "additional-options": _vm.options }
              },
              "component",
              layer,
              false
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_LGeoJsonCollection_vue__ = __webpack_require__(11);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_LGeoJsonLayer_vue__ = __webpack_require__(12);
/* unused harmony namespace reexport */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_LMap_vue__ = __webpack_require__(17);
/* unused harmony namespace reexport */
...
var update = __webpack_require__(16)("58ce521c", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(16)("2b3228f4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
                    ...
                    _vm._b(
                      {
                        key: index,
                        tag: "component",
                        attrs: { "layer-name": layer.label, order: index }
                      },
                      "component",
                      layer,
                      false
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_LMarker_vue__ = __webpack_require__(18);
/* unused harmony namespace reexport */
